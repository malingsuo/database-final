...
export const mockCheckResult: CheckResult = {
  ...
  ge_check: {
    ...
    categories: [
      {
        category_name: '外國語文領域',
        remark_code: '外文通',
        credits_required_min: 6,
        credits_required_max: 6,
        earned_credits: 6,
        missing_credits: 0,
        status: 'complete',
        courses: [
          { course_name: '大學國文', course_code: 'GE101', credits: 3, score: '88', ge_label: 1, allocated_category: '中文通' },
          { course_name: '大學英文', course_code: 'GE102', credits: 3, score: '90', ge_label: 2, allocated_category: '外文通' },
        ],
      },
      {
        category_name: '人文學通識',
        remark_code: '人文通',
        credits_required_min: 3,
        credits_required_max: 7,
        earned_credits: 2,
        missing_credits: 1,
        status: 'incomplete',
        courses: [{ course_name: '音樂與生活', course_code: 'GE210', credits: 2, score: '通過', ge_label: 64, allocated_category: '人文通' }],
      },
      {
        category_name: '社會科學通識',
        remark_code: '社會通',
        credits_required_min: 3,
        credits_required_max: 7,
        earned_credits: 3,
        missing_credits: 0,
        status: 'complete',
        courses: [{ course_name: '經濟學原理', course_code: 'GE320', credits: 3, score: '79', ge_label: 32, allocated_category: '社會通' }],
      },
      {
        category_name: '自然科學通識',
        remark_code: '自然通',
        credits_required_min: 3,
        credits_required_max: 7,
        earned_credits: 0,
