...
<strong>Step 4:</strong> 處理1:1 Relationship Types<br>
    user(<ins>id</ins>, email, password, role)<br>
    adminstrator(<ins>id</ins>, <span style="color:red">department_id (FK), user_id (FK)</span>)<br>
...
<strong>Step 5:</strong> 處理1:N Relationship Types<br>
    user(<ins>id</ins>, email, password, role)<br>
    adminstrator(<ins>id</ins>, department_id (FK), user_id (FK))<br>
...
adminstrator(<ins>id</ins>, department_id (FK), user_id (FK)) \
