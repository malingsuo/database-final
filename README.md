...
<strong>Step 1:</strong> 將所有一般Entity types轉換為Table<br>
    ...
    course(<ins>id</ins>, course_code, year, semester, name, credits, type, ge_label, group_label)<br>
</p>
<p>
...
<strong>Step 5:</strong> 處理1:N Relationship Types<br>
    ...
    department(<ins>id</ins>, college, name)<br>
    course(<ins>id</ins>, course_code, year, semester, name, credits, type, ge_label, group_label, <span style="color:red">department_id (FK)</span>)<br>
</p>
<p>
<strong>Step 6:</strong> 處理M:N Relationship Types<br>
    ...
    department(<ins>id</ins>, college, name)<br>
    course(<ins>id</ins>, course_code, year, semester, name, credits, type, ge_label, group_label, department_id (FK))<br>
...
course(<ins>id</ins>, course_code, year, semester, name, credits, type, ge_label, group_label, department_id (FK)) \
